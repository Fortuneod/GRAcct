...
<p style="font-size:20px;font-weight:bold;padding:10px">Logged In As: <span style="text-transform:uppercase;"><?php echo $username; ?></span><span style="float:right;"><a href="logout.php"><input type="button" value="Logout"  style="background:#f66;"></a></span></p>
...
<td>Role:</td>
<td><select name="role"><option value="">-Choose Role-</option><option>Accountant</option><option>Accounts Officer</option></select></td>
</tr>
<tr>
